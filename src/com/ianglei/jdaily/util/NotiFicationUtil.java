...
public class NotiFicationUtil {
	...
	public static void showNotification(Context context,String musicName)
	{
        ...
        // 定义Notification的各种属性   
		notification=new Notification(R.drawable.play,   
                "JDaily", System.currentTimeMillis()); 
        ...
        Intent notificationIntent =new Intent(context, DetailActivity.class); // 点击该通知后要跳转的Activity   
